...
const upcomingWorks = [
  {
    ...
    description2:
      "False Positive is the true story of a man who outruns his past but never forgets it. As a student, soldier, international drug dealer, outlaw, lover, and mercenary, Tristan travels the world — from armed home invasions in Mississippi to mountain top temples in Nepal, from Southeast Asian prisons to battlefields in Eastern Europe — chasing truth, redemption, and ultimately, justice. When the woman he loves, Ashley Oosthuizen, is wrongfully imprisoned and sentenced to death in Thailand, Tristans&#39; mission becomes clear. What began as a reckless search for freedom turns into an international fight for someone else&#39;s. ",
    description3:
